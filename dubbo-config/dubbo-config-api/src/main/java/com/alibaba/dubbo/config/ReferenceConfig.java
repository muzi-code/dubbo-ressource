...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        //从系统属性和dubbo.properties中拿属性设置到ConsumerConfig中
        //这个是默认配置，全局配置
        checkDefault();
        //系统属性和dubbo.properties中拿属性设置到ReferenceConfig中
        ...
        //把application，module，consumer，ReferenceConfig等属性设置到map中
